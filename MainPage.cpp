...
QLabel* MainPage::createEventDesign(const QString& backgroundPath, const QString& eventText, bool isConcert, void (MainPage::* slot)(bool))
{
    ...
    connect(addButton, &QPushButton::clicked, this, [=]() { emit(this->*slot)(isConcert); });
